...
class AppinfoFile:
    ...
    def get_app_sortas(self, appid: int) -> str:
        return self._appinfo["apps"][appid]["content"]["appinfo"]["common"]["sortas"]

    def get_app_type(self, appid: int) -> str:
    ...
    def get_app_steam_release_date(self, appid: int) -> int:
    ...
    def get_app_original_release_date(self, appid: int) -> int:
